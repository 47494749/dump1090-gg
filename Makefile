...
dump1090: dump1090.o anet.o interactive.o mode_ac.o mode_s.o comm_b.o net_io.o crc.o demod_2400.o stats.o cpr.o icao_filter.o track.o util.o convert.o ais_charset.o adaptive.o elm.o cpdlc_decode.o mlat_client.o piaware_client.o fa_mlat.o planefinder_client.o fr24_client.o radarbox_client.o flarm_decode.o flarm_demod.o flarm_reader.o ogntp_decode.o ogn_client.o opensky_client.o sondehub_client.o feeder_thread.o config_panel.o sdr_receiver.o acars_demod.o vdl2_demod.o sonde_demod.o pocsag_demod.o gsm_calibrate.o gsm_decode.o gsm_tracker.o lte_decode.o lte_tracker.o $(SDR_OBJ) $(COMPAT) $(CPUFEATURES_OBJS) $(STARCH_OBJS)
