                         ...
                         const int8_t *parity1, int K, uint8_t *out_bits)
{
    ...
    for (int iter = 0; iter < TC_MAX_ITER; iter++) {
        ...
        float *alpha_store = malloc((K + 1) * TC_STATES * sizeof(float));
        ...
        float *alpha2 = malloc(TC_STATES * sizeof(float));
        float *alpha2_store = malloc((K + 1) * TC_STATES * sizeof(float));
        float *gamma2 = malloc(K * TC_STATES * 2 * sizeof(float));
                          ...
                          uint8_t *out_bits, int *out_len)
{
    ...
    *out_len = 0;
    ...
    int8_t *sys_soft = calloc(K_turbo, sizeof(int8_t));
    int8_t *p0_soft = calloc(K_turbo, sizeof(int8_t));
    int8_t *p1_soft = calloc(K_turbo, sizeof(int8_t));
    ...
    // Turbo decode
    uint8_t *decoded = calloc(K_turbo, 1);
